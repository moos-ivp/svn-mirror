...
(setq moos-bhv-and-keyword-list
      (list
       ...
       '("BHV_ConvoyV21" "post_mapping" "contact" "post_recap_verbose" "radius" "capture_radius" "slip_radius" "inter_mark_range" "tail_length_max" "full_stop_convoy_range" "slower_convoy_range" "ideal_convoy_range" "faster_convoy_range" "full_lag_convoy_range" "lag_speed_delta" "convoy_flag" "marker_flag" "visual_hints" "patience")

       '("BHV_ConvoyV21X" "post_mapping" "contact" "post_recap_verbose" "radius" "capture_radius" "slip_radius" "inter_mark_range" "tail_length_max" "full_stop_convoy_range" "slower_convoy_range" "ideal_convoy_range" "faster_convoy_range" "full_lag_convoy_range" "lag_speed_delta" "convoy_flag" "marker_flag" "visual_hints" "patience" "active_convoying")
       ...
       '("BHV_Muster" "capture_radius" "activate_radius" "speed" "stale_nav_thresh" "stale_poly_thresh" "muster_region" "setpt_method" "capture_flag" "post_prox_poly" "visual_hints" )

       '("BHV_MusterX" "capture_radius" "activate_radius" "speed" "stale_nav_thresh" "muster_region" "setpt_method" "capture_flag" "region_in_flag" "region_out_flag" "visual_hints" )
