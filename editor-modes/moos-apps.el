...
(setq moos-app-and-keyword-list
      ...
      '("uFldNodeComms" "comms_range" "critical_range" "stale_time" "min_msg_interval" "max_msg_length" "view_node_rpt_pulses" "verbose" "stealth" "earange" "groups" "min_rpt_interval" "pulse_duration")
      ...
      '("uFldShoreBroker" "warning_on_stale" "bridge" "qbridge" "auto_bridge_realmcast" "auto_bridge_appcast" )
      '("uCommand" "cmd")
      '("uFldNodeBroker" "keyword" "try_shore_host" "bridge"  "auto_bridge_realmcast" "auto_bridge_appcast" )
      ...
      '("pObstacleMgr" "point_var" "obstacles_color" "given_obstacle" "post_dist_to_polys" "post_view_polys" "max_pts_per_cluster" "max_age_per_point" "alert_range" "ignore_range" "lasso" "lasso_points" "lasso_radius" "obstacles_color" "poly_label_thresh" "poly_shade_thresh" "poly_vertex_thresh" )
