...
(setq moos-bhv-and-keyword-list
      (list
       ...
       '("BHV_MaxSpeed" "basewidth" "max_speed" "tolerance")
       ...
       '("BHV_Timer")
       '("BHV_AvoidObstacle" "poly" "allowable_ttc" "pwt_outer_dist" "pwt_inner_dist" "buffer_dist" "obstacle_key" "completed_dist" "no_alert_request" "i_understand_this_behavior_is_deprecated")
       '("BHV_AvoidObstacleX" "poly" "allowable_ttc" "pwt_outer_dist" "pwt_inner_dist" "min_util_cpa_dist" "max_util_cpa_dist" "obstacle_key" "completed_dist" "no_alert_request" "use_refinery" "i_understand_this_behavior_is_deprecated")
       '("BHV_AvoidObstacleV21" "poly" "allowable_ttc" "pwt_outer_dist" "pwt_inner_dist" "min_util_cpa_dist" "max_util_cpa_dist" "obstacle_key" "completed_dist" "no_alert_request" "use_refinery" "id")
