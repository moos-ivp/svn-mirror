...
void showSynopsis()
{
  blk("SYNOPSIS:                                                       ");
  blk("------------------------------------                            ");
  blk("  The pObstacleManager manages incoming sensor dataabout        ");
...
void showHelpAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("Usage: pObstacleManager file.moos [OPTIONS]                     ");
  blu("=============================================================== ");
  blk("                                                                ");
  showSynopsis();
  blk("                                                                ");
  ...
  blk("      Launch pObstacleManager with the given process name       ");
  blk("      rather than pObstacleManager.                             ");
  mag("  --example, -e                                                 ");
  ...
  mag("  --version,-v                                                  ");
  blk("      Display the release version of pObstacleManager.          ");
  blk("                                                                ");
...
void showExampleConfigAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("pObstacleManager Example MOOS Configuration                     ");
  blu("=============================================================== ");
  blk("                                                                ");
  blk("ProcessConfig = pObstacleManager                                ");
  blk("{                                                               ");
  blk("  AppTick   = 4                                                 ");
  blk("  CommsTick = 4                                                 ");
  blk("                                                                ");
...
void showInterfaceAndExit()
{
  blk("                                                                ");
  blu("=============================================================== ");
  blu("pObstacleManager INTERFACE                                      ");
  blu("=============================================================== ");
  blk("                                                                ");
  showSynopsis();
  blk("                                                                ");
...
{
  showReleaseInfo("pObstacleManager", "gpl");
  exit(0);
}
