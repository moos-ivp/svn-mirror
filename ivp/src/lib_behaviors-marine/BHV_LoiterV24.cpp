...
BHV_LoiterV24::BHV_LoiterV24(IvPDomain gdomain) : 
  IvPBehavior(gdomain)
{
  // First set variables at the superclass level
  m_descriptor = "loiter24";  
  ...
  // Init State Variables with initial vals of zero which
...
bool BHV_LoiterV24::setParam(string param, string value) 
{
  ...
  if(param == "polygon") {
    ...
    updateCenter(); // mikerb 08/29/12 to ensure updates are immediate
    return(true);
  }  
    ...
    return(setBooleanOnString(m_center_activate, value));
  ...
  else if(param == "acquire_dist") 
    return(setNonNegDoubleOnString(m_acquire_dist, value));
  ...
  else if(param == "flag180")
    return(addVarDataPairOnString(m_flags180, value));
...
void BHV_LoiterV24::onCompleteState()
{
  postErasablePoint();
  postErasablePolygon();
...
void BHV_LoiterV24::onIdleState()
{
  postErasablePoint();
  postErasablePolygon();
...
void BHV_LoiterV24::onIdleToRunState()
{
  postConfigStatus();
...
IvPFunction *BHV_LoiterV24::onRunState() 
{
...
bool BHV_LoiterV24::updateInfoIn()
{
...
void BHV_LoiterV24::updateCenter()
{
  if(!m_center_pending)
    return;
...
void BHV_LoiterV24::updateLoiterMode()
{
...
IvPFunction *BHV_LoiterV24::buildIPF(string method) 
{
  IvPFunction *ipf = 0;
...
void BHV_LoiterV24::postStatusReports()
{
...
void BHV_LoiterV24::postViewablePolygon()
{
...
void BHV_LoiterV24::postErasablePolygon()
{
  XYSegList seglist = m_waypoint_engine.getSegList();
  string bhv_tag = tolower(getDescriptor());
...
void BHV_LoiterV24::postViewablePoint()
{
  string bhv_tag = tolower(getDescriptor());
...
void BHV_LoiterV24::postErasablePoint()
{
  string bhv_tag = tolower(getDescriptor());
...
void BHV_LoiterV24::handleVisualHint(string hint)
{
...
void BHV_LoiterV24::postConfigStatus()
{
  string str = "type=BHV_LoiterV24,name=" + m_descriptor;
