...
#ifndef BHV_LOITER_V24_HEADER
#define BHV_LOITER_V24_HEADER
...
class IvPDomain;
class BHV_LoiterV24 : public IvPBehavior {
public:
  BHV_LoiterV24(IvPDomain);
  ~BHV_LoiterV24() {}
...
private:  // Configuration Parameters
  ...
  std::vector<VarDataPair> m_flags180;
