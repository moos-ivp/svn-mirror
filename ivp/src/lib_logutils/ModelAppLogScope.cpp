...
void ModelAppLogScope::setDataBroker(ALogDataBroker dbroker, unsigned int mix)
{
  m_dbroker = dbroker;
  setVarPlot(mix);
}
...
void ModelAppLogScope::setAppLogPlot(unsigned int mix)
{
  m_now_entries.clear();
  addAppLogPlot(mix);
}
...
//-------------------------------------------------------------
// procedure: addAppLogPlot

void ModelAppLogScope::addAppLogPlot(unsigned int mix)
{
  AppLogPlot alplot = m_dbroker.getAppLogPlot(mix, true); // true means get source info
...
void ModelAppLogScope::delVarPlot(unsigned int mix)
{
...
void ModelAppLogScope::reformat()
{
...
void ModelAppLogScope::reformat(list<VarPlotEntry>& entries)
{
  list<VarPlotEntry>::iterator p;
...
list<VarPlotEntry> ModelAppLogScope::mergePlots(list<VarPlotEntry> plota, 
...
vector<string> ModelAppLogScope::getPastEntries() const
{
...
vector<string> ModelAppLogScope::getSoonEntries() const
{
...
vector<string> ModelAppLogScope::getEntries(const list<VarPlotEntry>& entries) const
{
