...
MARK_LIST="NOTABLE_EFF,NOTABLE_CPA"
...
for dirs in $DIR/LOG*/ ; do 
    cd $dirs
    alogscan --rate_only --noaux LOG*.alog
    echo "alogpare LOG*.alog name.alog --pare_window=$PARE_WINDOW "
	...
	alogscan --rate_only --noaux *_pared.alog
    fi
